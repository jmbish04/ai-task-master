/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ac7a0d3204356f981030d07dde850d5d)
// Runtime types generated with workerd@1.20250917.0 2025-03-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WebSocketServer" | "CodeGeneratorDO";
	}
	interface Env {
		CACHE: KVNamespace;
		WEBSOCKET_SERVER: DurableObjectNamespace<import("./src/index").WebSocketServer>;
		CODE_GENERATOR: DurableObjectNamespace<import("./src/index").CodeGeneratorDO>;
